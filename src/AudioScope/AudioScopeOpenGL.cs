...
namespace AudioScope
{
    ...
    {
        private const string VERTEX_SHADER_PATH = "shaders/line.vert";
        private const string FRAGMENT_SHADER_PATH = "shaders/line.frag";
        private const string GEOMETRY_SHADER_PATH = "shaders/line.geom";
